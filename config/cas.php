...
return [
    ...
    */
    'cas_hostname'        => env('CAS_HOSTNAME', 'muidp.miamioh.edu'),
    ...
    */
    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'muidp.miamioh.edu'),
    ...
    */
    'cas_cert'                => env('CAS_CERT', '/usr/share/ca-certificates/mozilla/AddTrust_External_Root.crt'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://muidp.miamioh.edu/cas/logout'),
