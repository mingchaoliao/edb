...
@section('content')
    ...
    <h1 style="text-align: center;">Ethnobotanical Database</h1>

    <h3 style="margin-top: 15px;">Project Abstract:</h3>
    ...
    <img src="{{asset('img/myaamia.jpg')}}" style="width: 100%; margin-top: 15px;">
@endsection
